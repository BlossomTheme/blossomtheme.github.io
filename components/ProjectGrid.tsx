    ...
    <section id="projects" className="py-32 px-8 overflow-hidden">
      <div className="max-w-[1800px] mx-auto">
        <div className="flex flex-col mb-32 reveal">
           <h2 className="text-[#FF85A2] font-black text-sm tracking-[0.4em] mb-4 uppercase">Selected Works</h2>
           <h3 className="text-6xl md:text-8xl font-serif font-black text-[#4A148C]">The Ecosystem</h3>
        </div>
          ...
          {PROJECTS.map((project, idx) => (
            ...
            >
              <div className="w-full lg:w-3/5 group relative overflow-hidden rounded-[60px] shadow-2xl">
                ...
                {/* AI Generated Project Visual */}
                <GeneratedImage 
                  subject={`Abstract minimalist digital illustration representing ${project.title} development theme with sakura motifs`}
                  className="aspect-[16/9] w-full group-hover:scale-110 transition-transform duration-700"
