...
const HomePage: React.FC = () => {
  ...
  return (
    <>
      <LoadingScreen />
      <div className="manga-grid h-screen w-screen overflow-hidden">
        <SakuraPetals />
        ...
        >
          <div className="h-full flex items-center justify-center">
            <a 
              href="https://github.com/BlossomTheme/BlossomTheme"
          ...
          <div className="bg-white/95 p-4 md:p-6 border-l-8 border-[#ff058d] h-full flex flex-col shadow-inner justify-between">
            <div>
              <div className="flex items-center gap-2 mb-6">
                ...
                <h2 className="font-manga text-2xl md:text-4xl text-[#9200ff]">OUR WORK</h2>
              </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center">
               <button 
                ...
                className="group relative inline-block scale-90 md:scale-100 cursor-pointer"
               >
